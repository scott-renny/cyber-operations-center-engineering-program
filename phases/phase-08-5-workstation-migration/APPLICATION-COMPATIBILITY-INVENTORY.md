...
Prevent a Fedora installation from stranding an essential Windows workflow. Every required application must have a tested disposition before the Windows workstation is sanitized.

## Decision categories

| Category | Preferred use |
|---|---|
| Native Fedora package | First choice when maintained by Fedora or the verified upstream publisher |
| Flatpak | Desktop application delivered through a reviewed Fedora or Flathub source |
...
| Windows application or workflow | Business or lab requirement | Fedora disposition | Data/configuration needed | Validation test | Decision |
|---|---|---|---|---|---|
...
| Git and development tools | Engineering | Fedora packages and isolated environments | Repositories and reviewed configuration | Clone, build, and commit test | Pending |
...
- Reinstall software only from Fedora repositories, reviewed Flatpak remotes, or verified upstream publishers.
